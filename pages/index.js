...
export default function Home() {
  ...
  return (
    <div className={` ${theme}`}>
      <div className="p-10 bg-white dark:bg-gray-600 h-screen overflow-hidden">
        <button
          onClick={() =>
            setTheme((prev) => {
              return !prev ? "dark" : "";
          ...
          className="dark:bg-blue-100 bg-blue-200 text-blue-600 p-3 rounded-md mb-10"
        >
          Toggle dark mode
        </button>
        ...
        <section className="flex mt-44">
          ...
          >
            ...
            />
            <path
              d="M179.84 733.435s1.487-31.159 31.972-27.537"
              fill="#3f3d56"
            />
